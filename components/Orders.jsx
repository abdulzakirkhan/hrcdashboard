...
//                     <circle cx="21" cy="21" r="13" fill="none" className={`stroke-current ${Number(order.completepercentage) === 100 ? "text-[#3BB537]" : Number(order.completepercentage) > 0 ? "text-yellow" :  "text-grey" } dark:text-blue-500`} strokeWidth="2.7" strokeDasharray="100" strokeDashoffset={order?.remaining} strokeLinecap="round"></circle>
//                   </svg>

//                   <div className="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2">
//                     <span className="text-center text-xl font-bold text-black dark:text-blue-500">{order?.completepercentage}%</span>
//                   </div>
//                 </div>
